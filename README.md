...
We would like you to create a tool which gives users the ability to search for animated images and display the results back to the user.
...
- Search for images
- View the results
- Optionally change the number of results displayed (default is 1, max number is 100)
- Allow the user to filter the displayed results based on the rating property (y, g, pg, pg-13 or r) without making a calling to the API. The API will return the rating property as part of the response for you.

### What we are looking for
While the code for this task could all be done in a single file, we are looking for how you approach the following:
- State management
- Managing API calls
